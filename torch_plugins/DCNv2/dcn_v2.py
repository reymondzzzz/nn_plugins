...
class _DCNv2(Function):
    ...
    def symbolic(g, input, offset, mask, weight, bias, stride, padding, dilation, deformable_groups):
        return g.op("CustomPlugin::DCNv2", input, offset, mask, weight, bias, name_s="DCNv2", info_s=json.dumps({
            "dilation": dilation,
            "padding": padding,
            "stride": stride,
...
register_custom_op_symbolic('CustomPlugin::DCNv2', dcn_v2_conv, 11)
